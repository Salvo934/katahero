...
const plans: Plan[] = [
  {
    ...
    talentBoardLine:
      "Stessa cura visiva delle mini schede che vedi sulla Talent Board: un solo standard professionale.",
  ...
  },
  {
    ...
    talentBoardLine:
      "Talent Board privata con le stesse mini schede e logica di /talent-board — ma con i tuoi atleti e accessi controllati.",
    featuresSectionTitle: "Cosa include",
    features: [
      ...
      <div className="relative mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mt-5 text-base leading-relaxed text-zinc-400 sm:text-lg">
            ...
            <strong className="font-semibold text-zinc-300">Talent Board</strong> privata — filtri,
          ...
          <div className="mt-6 flex flex-wrap items-center justify-center gap-3">
            ...
            <span className="hidden text-[11px] text-zinc-600 sm:inline">Profilo reale Ilario Simonetti · board pubblica</span>
          </div>
        </div>
