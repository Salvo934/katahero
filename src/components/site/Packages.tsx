...
const tiers: Tier[] = [
  {
    ...
    features: [
      ...
      "Instagram: 2 Storie + 2 post al mese su richiesta — per gara, risultato o annuncio dopo la tua prestazione",
  ...
  },
  {
    ...
    features: [
      ...
      "Instagram: 3 Storie + 3 post al mese su richiesta — ideali per match day, vittorie e contenuti legati alle tue performance",
  ...
  },
  {
    ...
    features: [
      ...
      "Instagram: 4 Storie + 4 post al mese su richiesta — per gare top, sponsor, fine stagione e i momenti che vuoi far vedere",
