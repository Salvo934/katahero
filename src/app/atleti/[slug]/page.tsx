    ...
    <div className="flex min-h-full flex-col">
      ...
      <main className="flex-1 border-t border-white/10 bg-zinc-950 pt-24 pb-16 sm:pt-28">
        <div className="mx-auto max-w-2xl px-4 sm:px-6 lg:px-8">
          {athlete ? (
            <>
              <p className="text-[11px] font-semibold uppercase tracking-[0.28em] text-accent">Profilo atleta · KataHero</p>
            ...
            <>
              ...
              <p className="mt-3 text-zinc-500">Questo profilo non è presente nella Talent Board.</p>
            </>
          )}
